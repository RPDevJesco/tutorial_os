/*
 * soc/bcm2710/display_dpi.c - BCM2711 Display Implementation (DPI/HDMI)
 *
 * Tutorial-OS: BCM2711 HAL Implementation
 *
 * Implements hal_display.h for BCM2711.
 *
 ...
 * =============================================================================
 * This uses existing fb_init_with_size() mailbox code.
 */
 ...
 * DISPLAY CONTROL
 * =============================================================================
 * These match the existing fb_present() and fb_set_vsync() functions.
 */
