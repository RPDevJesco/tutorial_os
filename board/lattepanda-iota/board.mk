# =============================================================================
# board/lattepanda-iota/board.mk — LattePanda IOTA Board Configuration
# =============================================================================
#
# WHAT THIS FILE DOES:
#   1. Selects the lattepanda_n150 SoC layer (Intel N150, AlderLake ULX)
...
BOARD_INCLUDES := \
    -Iboard/lattepanda-iota

BOARD_DEFINES := \
    -DBOARD_LATTEPANDA_IOTA=1 \
    -DBOARD_NAME="\"LattePanda IOTA\"" \
    -DDISPLAY_WIDTH=1920 \
