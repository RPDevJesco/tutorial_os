/*
 * font_data.rs — Bitmap Font Data (8×8 and 8×16)
 *
 * Tutorial-OS: Portable Framebuffer Driver (Rust)
 *
 * Standard VGA bitmap fonts covering ASCII 32–126 (95 printable characters).
 * Each glyph is a sequence of bytes where each byte represents one row,
 * with the MSB corresponding to the leftmost pixel.
 */
...
pub const FONT_8X16: [[u8; 16]; 95] = [
    ...
    [0x00, 0x00, 0xE6, 0x66, 0x6C, 0x6C, 0x78, 0x78, 0x6C, 0x66, 0x66, 0xE6, 0x00, 0x00, 0x00, 0x00],    // 'K' (75)
    ...
    [0x00, 0x00, 0xFF, 0xDB, 0x99, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x3C, 0x00, 0x00, 0x00, 0x00],    // 'T' (84)
    ...
    [0x00, 0x00, 0xC6, 0xC6, 0xC6, 0xC6, 0xC6, 0xD6, 0xD6, 0xFE, 0xEE, 0x6C, 0x00, 0x00, 0x00, 0x00],    // 'W' (87)
    [0x00, 0x00, 0xC6, 0xC6, 0x6C, 0x7C, 0x38, 0x38, 0x7C, 0x6C, 0xC6, 0xC6, 0x00, 0x00, 0x00, 0x00],    // 'X' (88)
    [0x00, 0x00, 0xC6, 0xC6, 0xC6, 0x6C, 0x38, 0x18, 0x18, 0x18, 0x18, 0x3C, 0x00, 0x00, 0x00, 0x00],    // 'Y' (89)
    ...
    [0x00, 0x00, 0xE0, 0x60, 0x60, 0x78, 0x6C, 0x66, 0x66, 0x66, 0x66, 0xDC, 0x00, 0x00, 0x00, 0x00],    // 'b' (98)
    ...
    [0x00, 0x00, 0x00, 0x00, 0x00, 0xDC, 0x76, 0x62, 0x60, 0x60, 0x60, 0xF0, 0x00, 0x00, 0x00, 0x00],    // 'r' (114)
